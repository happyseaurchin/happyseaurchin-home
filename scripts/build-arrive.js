...
const PAGES = [
  ...
  },
  {
    src: 'touch.md',
    out: 'touch.html',
    title: 'touch — the same loop, live · happyseaurchin',
    description: 'Second step: verify a live block other minds authored, locate yourself on a mirror block, build the fifty-line function and prove it by reproduction, reach toward a living entity.',
    canonical: 'https://happyseaurchin.com/touch',
    alternate: 'https://happyseaurchin.com/touch.md',
    ogDescription: 'The arrive loop against the live commons: slate, the compass, your own build, and the torus.',
  },
  {
    src: 'engage.md',
    out: 'engage.html',
    title: 'engage — what are we going to do about it · happyseaurchin',
    description: 'Third step, openly speculative: the evolution ladder as a checkable object, two attractors, and a menu of enactments from a mark to a shell — with the path you took as public, self-sorted data.',
    canonical: 'https://happyseaurchin.com/engage',
    alternate: 'https://happyseaurchin.com/engage.md',
    ogDescription: 'The five-level ladder, the attractor cloud, enactment rungs, and ten types of reader — the sorting is the data.',
  },
  {
    src: 'shell.md',
    out: 'shell.html',
